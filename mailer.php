...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recipient = "info@calvetpro.com";

    //email subject.
    $subject = "IMPORTANT CalVet! New message from $name";
    ...
    $response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6Lf0zBcUAAAAAGCRLwxeIjwAQxM8O9lq_yHNzYAi&response=".$captcha."&remoteip=".$_SERVER['REMOTE_ADDR']);
